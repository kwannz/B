...
describe('Workflow Metrics Validation - System Level', () => {
  const mockRouter = {
    push: jest.fn(),
    replace: jest.fn(),
    back: jest.fn(),
  ...
  it('should validate system health metrics during workflow', async () => {
    await testRunner.runTest(async () => {
      ...
      // Step 1: Agent Selection with System Metrics
      ...
      // Step 3: Bot Integration with System Health Check
      rerender(
        <TestContext>
          <BotIntegration />
        </TestContext>
      ...
      // Step 4: Key Management with Performance Validation
      rerender(
        <TestContext>
          <KeyManagement />
        </TestContext>
      ...
      // Step 5: Trading Dashboard with System Metrics
      rerender(
        <TestContext>
          <TradingDashboard />
        </TestContext>
      ...
      // Step 6: Wallet Comparison with Performance Analysis
      rerender(
        <TestContext>
          <WalletComparison />
        </TestContext>
