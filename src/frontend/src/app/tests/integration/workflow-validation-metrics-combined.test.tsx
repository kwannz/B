...
describe('Workflow Validation with Combined Metrics', () => {
  ...
  it('validates complete workflow with combined metrics', async () => {
    ...
    for (const page of pages) {
      ...
      monitoringData.api_latency.push(mockWalletA.metrics.api_latency);
