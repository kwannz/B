...
from tradingbot.api.services.raydium_swap import raydium_swap_service
...
async def execute_test_swap():
    try:
        logger.info("Getting Raydium swap quote for USDC to SOL...")
        quote = await raydium_swap_service.get_swap_quote(
        ...
        if quote["success"]:
            ...
            result = await raydium_swap_service.execute_swap(quote)
        ...
        await raydium_swap_service.close()
