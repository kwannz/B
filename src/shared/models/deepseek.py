    ...
    def get_memory_stats(self) -> Dict[str, float]:
        try:
            ...
            return {
                ...
                "memory_reduction": 1 - (current_memory / self.initial_memory) if self.initial_memory and self.initial_memory > 0 else 0
            }
        except RuntimeError:
            return {"current_memory_mb": 0.0, "peak_memory_mb": 0.0, "memory_reduction": 0.0}
        ...
        try:
            ...
            try:
                ...
                with torch.inference_mode():
                    with torch.cuda.amp.autocast() if self._quantized and torch.cuda.is_available() else nullcontext():
