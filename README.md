...
│   │   └── executor/ # Trade execution components
│   └── api_gateway/  # Main API endpoints
└── shared/           # Core modules
    ├── trading/      # Trading core components
    │   └── executor/ # Shared execution utilities
    ├── services/     # Business logic
    │   ├── ai_analyzer/    # DeepSeek R1/V3 integration
    │   ├── news_collector/ # News aggregation
...
Environment files are centralized in `deploy/config/`:
- `.env`: Main configuration file
- `.env.frontend`: Frontend-specific settings
- `.env.example`: Template with required variables

## Development
- Frontend: React 18 with TypeScript and Vite
- Backend: FastAPI with PostgreSQL and Redis
- AI Models: DeepSeek R1/V3 for sentiment analysis
