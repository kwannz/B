...
async def test_validate_with_ai_success():
    ...
    with patch("src.shared.ai_analyzer.AIAnalyzer.validate_trade", new_callable=AsyncMock) as mock_validate:
    ...
    test_cases = [
        {
            "validation": {
                ...
                "validation_metrics": {"market_conditions_alignment": 0.7, "risk_reward_ratio": 2.0}
            },
        ...
        },
        {
            "validation": {
                ...
                "validation_metrics": {"market_conditions_alignment": 0.5, "risk_reward_ratio": 2.0}
            },
        ...
        },
        {
            "validation": {
                "is_valid": True,
                "risk_assessment": {"risk_level": 0.7, "max_loss": 5.0},
                "validation_metrics": {"market_conditions_alignment": 0.7, "risk_reward_ratio": 1.2}
            },
