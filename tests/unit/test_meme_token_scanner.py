...
@pytest.fixture
def scanner_config():
    return {"max_market_cap": 30000, "min_volume": 1000}
    ...
    return [
        {
            ...
            "symbol": "test1",
            "name": "Test Token 1",
            "platforms": {"solana": "So1ana111111111111111111111111111111111111"},
        },
        {
            "id": "test-token-2",
            "symbol": "test2",
...
def mock_market_data():
    return {"test-token-1": {"usd": 0.1, "usd_market_cap": 25000, "usd_24h_vol": 2000}}
