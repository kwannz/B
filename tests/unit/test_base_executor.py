...
@pytest.fixture
def valid_config():
    return {"strategy_type": "test_strategy", "risk_level": "low", "trade_size": 1000}
...
def test_executor_config_validation():
    ...
    invalid_configs = [
        ...
        {"strategy_type": "test", "risk_level": "low"},  # Missing one field
    ]
...
def test_executor_config_validation_types():
    ...
    invalid_type_configs = [
        {"strategy_type": None, "risk_level": "low", "trade_size": 1000},
        {"strategy_type": "test", "risk_level": None, "trade_size": 1000},
        {"strategy_type": "test", "risk_level": "low", "trade_size": None},
        {"strategy_type": "", "risk_level": "low", "trade_size": 1000},  # Empty string
        {"strategy_type": "test", "risk_level": "", "trade_size": 1000},  # Empty string
        {
            "strategy_type": "test",
            "risk_level": "low",
    ...
    for config in invalid_type_configs:
        ...
        assert any(
            ...
            for msg in ["Missing required config fields", "Invalid value", "must be"]
        )
