...
async def test_analyze_sentiment_trends(ai_analyzer):
    historical_sentiment = [
        {"date": "2024-01-01", "sentiment": 0.8, "volume": 1000},
        {"date": "2024-01-02", "sentiment": 0.6, "volume": 1200},
    ]
...
async def test_analyze_sentiment_impact(ai_analyzer):
    sentiment_data = {"overall": 0.8, "news": 0.7, "social": 0.9}
    market_data = {"price": 19000, "volume": 1000000}
...
async def test_analyze_regional_sentiment(ai_analyzer):
    regional_data = {
        "US": {"sentiment": 0.8, "volume": 1000},
        "EU": {"sentiment": 0.6, "volume": 800},
        "Asia": {"sentiment": 0.7, "volume": 1200},
    }
...
async def test_analyze_sentiment_divergence(ai_analyzer):
    sentiment_data = {
        "news": {"sentiment": 0.8, "confidence": 0.9},
        "social": {"sentiment": 0.4, "confidence": 0.7},
        "technical": {"sentiment": 0.6, "confidence": 0.8},
    }
...
async def test_generate_sentiment_report(ai_analyzer):
    sentiment_data = {"overall": 0.8, "news": 0.7, "social": 0.9, "technical": 0.6}
