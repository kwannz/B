...
def upgrade():
    ...
    op.execute("CREATE TYPE alertlevel AS ENUM ('info', 'warning', 'error', 'critical')")
    ...
    op.create_table(
        ...
        sa.Column('type', postgresql.ENUM('market', 'limit', 'stop_loss', 'take_profit', name='ordertype'), nullable=False),
        sa.Column('side', postgresql.ENUM('buy', 'sell', name='orderside'), nullable=False),
        sa.Column('quantity', sa.Float(), nullable=False),
        sa.Column('price', sa.Float(), nullable=True),
        sa.Column('status', postgresql.ENUM('pending', 'open', 'filled', 'cancelled', 'failed', name='orderstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('risk_level', postgresql.ENUM('low', 'medium', 'high', name='risklevel'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('level', postgresql.ENUM('info', 'warning', 'error', 'critical', name='alertlevel'), nullable=False),
